...
interface MobileThemeDetailsPageProps {
...
export default function MobileThemeDetailsPage({
  activeProfile,
  ...
  if (theme === "prime") {
    ...
    return (
      <div className="pt-20 pb-24 text-zinc-300 font-sans min-h-screen bg-[#0b0c10] text-left animate-fade-in" id="prime-details-view">
        ...
        {/* Hero Segment */}
        <div className="relative max-w-7xl mx-auto px-6 grid grid-cols-1 gap-8 items-start mb-16">
          {/* Right Column: Giant Matte Artwork Overlay (MOVED TO TOP FOR MOBILE) */}
          <div className="col-span-1 relative aspect-video rounded-lg overflow-hidden bg-zinc-950 border border-zinc-850 shadow-2xl">
            <img 
          ...
          <div className="col-span-1 space-y-6 z-10 -mt-8 relative">
            {/* Logo details */}
            ...
            <div className="flex flex-col gap-3 w-full">
              <button
                ...
                className="flex items-center justify-center space-x-3 bg-white hover:bg-zinc-200 text-black w-full py-3.5 rounded-md font-bold transition duration-200 shadow-xl cursor-pointer text-sm"
              >
              ...
              <div className="flex items-center justify-center gap-4 py-2">
                ...
                >
                  ...
                  <span className="text-[10px] font-bold uppercase">Dislike</span>
                </button>
                ...
                >
                  {isDownloaded ? (
                    ...
                    <span className="text-[10px] font-bold h-6 flex items-center">{downloadProgress}%</span>
                  ) : (
            ...
            <div className="space-y-1.5 pt-2 border-t border-zinc-800/60 text-xs">
              <div>
                <span className="text-zinc-500 font-bold uppercase tracking-wider text-[11px] block">Directors</span>
                <span className="text-white font-medium">{movieData.director}</span>
              </div>
              <div>
                <span className="text-zinc-500 font-bold uppercase tracking-wider text-[11px] block">Starring</span>

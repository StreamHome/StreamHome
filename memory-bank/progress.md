...
- [x] Replaced incomplete theme-specific dashboard forks with one functional server-driven dashboard shell shared by Ember, Aurora, Cinema, and Gemini.
...
- [x] `npm test`
- [x] `npm run build`
- [x] Browser smoke test: `/login` rendered without page console errors.

...
async def run_setup_wizard():
    ...
    print_centered("[bold white]To start the managed production services:[/bold white]")
    print_centered("  - Linux : Run ./start.sh\n")
    print_centered("[bold white]To stop the managed production services:[/bold white]")
    print_centered("  - Linux : Run ./stop.sh\n")
    print_centered("[bold white]To open the management panel at any time, run:[/bold white]")
    print_centered("[bold bright_cyan]./venv/bin/python server/cli.py[/bold bright_cyan]")
    console.print()
